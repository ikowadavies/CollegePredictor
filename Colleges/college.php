	...
	<div class="container">
		...
		if(isset($_GET['cid'])) {
			...
			if($result) {
					...
					echo '<h1>'.$row[1].'<small> ('.$row[2].')</small></h1><hr><p><strong>Cut-off: </strong>'.$row[3].'<br>'.$row[4].'</p><p><strong><u>Contact</u></strong><br>Website: <a href="http://www.'.$row[5].'">http://www.'.$row[5].'</a><br>Phone: (+260)'.$row[6].'</p>';
